...
import { ScalingSphere } from "./scaling-sphere";
import { context, OnDragStartProps } from "./context";
import { BoundingBox } from "@/three/pivot-controls/bounding-box";
...
export const PivotControls: ForwardRefComponent<PivotControlsProps, THREE.Group> =
  /* @__PURE__ */ React.forwardRef<THREE.Group, PivotControlsProps>(function PivotControls(
    {
      enabled = true,
      matrix,
      onDragStart,
      ...
      <context.Provider value={config}>
        <group ref={parentRef}>
          <group ref={ref} matrix={matrix} matrixAutoUpdate={false} {...props}>
            ...
            <BoundingBox childrenRef={childrenRef} />
